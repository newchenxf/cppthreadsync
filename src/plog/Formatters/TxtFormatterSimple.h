...
namespace plog
{
    ...
    class TxtFormatterSimple : public TxtFormatterImplSimple<false> {};
    class TxtFormatterUtcTimeSimple : public TxtFormatterImplSimple<true> {};
}
